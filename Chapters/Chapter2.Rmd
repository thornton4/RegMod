...
<h6 style="text-align: center;"><a id="displayOver2.1A" href="javascript:toggleDet('toggleOver2.1A','displayOver2.1A');"><i><strong>Show Overhead A Details. Wisconsin lottery data description</strong></i></a> </h6>
<div id="toggleOver2.1A" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver2.1B" href="javascript:toggleDet('toggleOver2.1B','displayOver2.1B');"><i><strong>Show Overhead B Details. Summary statistics</strong></i></a> </h6>
<div id="toggleOver2.1B" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver2.1C" href="javascript:toggleDet('toggleOver2.1C','displayOver2.1C');"><i><strong>Show Overhead C Details. Visualizing skewed distributions</strong></i></a> </h6>
<div id="toggleOver2.1C" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver2.1D" href="javascript:toggleDet('toggleOver2.1D','displayOver2.1D');"><i><strong>Show Overhead D Details. Visualizing relationships with a scatter plot</strong></i></a> </h6>
<div id="toggleOver2.1D" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver2.1E" href="javascript:toggleDet('toggleOver2.1E','displayOver2.1E');"><i><strong>Show Overhead E Details. Correlation coefficient</strong></i></a> </h6>
<div id="toggleOver2.1E" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver2.2A" href="javascript:toggleDet('toggleOver2.2A','displayOver2.2A');"><i><strong>Show Overhead A Details. Where to fit the line?</strong></i></a> </h6>
<div id="toggleOver2.2A" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver2.2B" href="javascript:toggleDet('toggleOver2.2B','displayOver2.2B');"><i><strong>Show Overhead B Details. Method of least squares</strong></i></a> </h6>
<div id="toggleOver2.2B" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver2.2C" href="javascript:toggleDet('toggleOver2.2C','displayOver2.2C');"><i><strong>Show Overhead C Details. Regression coefficients</strong></i></a> </h6>
<div id="toggleOver2.2C" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver2.2D" href="javascript:toggleDet('toggleOver2.2D','displayOver2.2D');"><i><strong>Show Overhead D Details. Prediction</strong></i></a> </h6>
<div id="toggleOver2.2D" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver2.3A" href="javascript:toggleDet('toggleOver2.3A','displayOver2.3A');"><i><strong>Show OverheadS A and B Details. Visualizing the uncertainty about a line</strong></i></a> </h6>
<div id="toggleOver2.3A" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver2.3C" href="javascript:toggleDet('toggleOver2.3C','displayOver2.3C');"><i><strong>Show Overheads C, D and E Details. ANOVA Table</strong></i></a> </h6>
<div id="toggleOver2.3C" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver2.4A" href="javascript:toggleDet('toggleOver2.4A','displayOver2.4A');"><i><strong>Show Overhead A Details. Summary of basic linear regression model</strong></i></a> </h6>
<div id="toggleOver2.4A" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver2.4B" href="javascript:toggleDet('toggleOver2.4B','displayOver2.4B');"><i><strong>Show Overhead B Details. Hypothesis testing</strong></i></a> </h6>
<div id="toggleOver2.4B" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver2.4C" href="javascript:toggleDet('toggleOver2.4C','displayOver2.4C');"><i><strong>Show Overhead C Details. Confidence intervals</strong></i></a> </h6>
<div id="toggleOver2.4C" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver2.4D" href="javascript:toggleDet('toggleOver2.4D','displayOver2.4D');"><i><strong>Show Overhead D Details. Confidence intervals check</strong></i></a> </h6>
<div id="toggleOver2.4D" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver2.4E" href="javascript:toggleDet('toggleOver2.4E','displayOver2.4E');"><i><strong>Show Overhead E Details. Prediction intervals</strong></i></a> </h6>
<div id="toggleOver2.4E" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver2.5A" href="javascript:toggleDet('toggleOver2.5A','displayOver2.5A');"><i><strong>Show Overhead A Details. Unusual observations in regression</strong></i></a> </h6>
<div id="toggleOver2.5A" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver2.5B" href="javascript:toggleDet('toggleOver2.5B','displayOver2.5B');"><i><strong>Show Overhead B Details. Example. Outliers and High Leverage Points</strong></i></a> </h6>
<div id="toggleOver2.5B" style="display: none">   
...
<h6 style="text-align: center;"><a id="displayOver2.5C" href="javascript:toggleDet('toggleOver2.5C','displayOver2.5C');"><i><strong>Show Overhead C Details. Regression fit with 19 base observations</strong></i></a> </h6>
<div id="toggleOver2.5C" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver2.5D" href="javascript:toggleDet('toggleOver2.5D','displayOver2.5D');"><i><strong>Show Overhead D Details. Regression fit with 19 base observations plus C</strong></i></a> </h6>
<div id="toggleOver2.5D" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver2.5E" href="javascript:toggleDet('toggleOver2.5E','displayOver2.5E');"><i><strong>Show Overhead E Details. R code</strong></i></a> </h6>
<div id="toggleOver2.5E" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver2.5F" href="javascript:toggleDet('toggleOver2.5F','displayOver2.5F');"><i><strong>Show Overhead F Details. Visualizing four regression fits</strong></i></a> </h6>
<div id="toggleOver2.5F" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver2.5G" href="javascript:toggleDet('toggleOver2.5G','displayOver2.5G');"><i><strong>Show Overhead G Details. Results from four regression models</strong></i></a> </h6>
<div id="toggleOver2.5G" style="display: none">
