...
<h6 style="text-align: center;"><a id="displayOver4.1A" href="javascript:toggleDet('toggleOver4.1A','displayOver4.1A');"><i><strong>Show Overhead A Details. Iterative approach</strong></i></a> </h6>
<div id="toggleOver4.1A" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver4.1B" href="javascript:toggleDet('toggleOver4.1B','displayOver4.1B');"><i><strong>Show Overhead B Details. Many possible models</strong></i></a> </h6>
<div id="toggleOver4.1B" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver4.1C" href="javascript:toggleDet('toggleOver4.1C','displayOver4.1C');"><i><strong>Show Overhead C Details. Model validation</strong></i></a> </h6>
<div id="toggleOver4.1C" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver4.2A" href="javascript:toggleDet('toggleOver4.2A','displayOver4.2A');"><i><strong>Show Overhead A Details. Classic stepwise regression algorithm</strong></i></a> </h6>
<div id="toggleOver4.2A" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver4.2B" href="javascript:toggleDet('toggleOver4.2B','displayOver4.2B');"><i><strong>Show Overhead B Details. Drawbacks of stepwise regression</strong></i></a> </h6>
<div id="toggleOver4.2B" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver4.2C" href="javascript:toggleDet('toggleOver4.2C','displayOver4.2C');"><i><strong>Show Overhead C Details. Data-snooping in stepwise regression</strong></i></a> </h6>
<div id="toggleOver4.2C" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver4.2D" href="javascript:toggleDet('toggleOver4.2D','displayOver4.2D');"><i><strong>Show Overhead D Details. Variants of stepwise regression</strong></i></a> </h6>
<div id="toggleOver4.2D" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver4.2E" href="javascript:toggleDet('toggleOver4.2E','displayOver4.2E');"><i><strong>Show Overhead E Details. Automatic variable selection procedures</strong></i></a> </h6>
<div id="toggleOver4.2E" style="display: none">
...
ex() %>% check_object("model_step1") %>% check_equal()
ex() %>% check_object("model_step10") %>% check_equal()
ex() %>% check_function("anova",index=1) %>% check_result() %>% check_equal()
ex() %>% check_object("model_step50") %>% check_equal()
...
<h6 style="text-align: center;"><a id="displayOver4.3A" href="javascript:toggleDet('toggleOver4.3A','displayOver4.3A');"><i><strong>Show Overhead A Details. Residual analysis</strong></i></a> </h6>
<div id="toggleOver4.3A" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver4.3B" href="javascript:toggleDet('toggleOver4.3B','displayOver4.3B');"><i><strong>Show Overhead B Details. Using residuals to select explanatory variables</strong></i></a> </h6>
<div id="toggleOver4.3B" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver4.3C" href="javascript:toggleDet('toggleOver4.3C','displayOver4.3C');"><i><strong>Show Overhead C Details. Detecting relationships between residuals and explanatory variables</strong></i></a> </h6>
<div id="toggleOver4.3C" style="display: none">
...
ex() %>% check_object("mlr.survey1") %>% check_equal()
ex() %>% check_function("summary",index=1) %>% check_arg(., "object") %>% check_equal()
ex() %>% chek_function("plot",index=1) %>%{
  check_arg(., "x") %>% check_equal()
  check_arg(., "y") %>% check_equal()
}
ex() %>% check_function("lines",index=1)
ex() %>% check_function("lowess",index=1) %>%{
  check_arg(., "x") %>% check_equal()
  check_arg(., "y") %>% chec_equal()
}
ex() %>% check_object("mlr.survey2") %>% check_equal()
ex() %>% check_function("summary",index=2) %>% check_arg(., "object") %>% check_equal()
ex() %>% chek_function("plot",index=2) %>%{
  check_arg(., "x") %>% check_equal()
  check_arg(., "y") %>% check_equal()
}
ex() %>% check_function("lines",index=2)
ex() %>% check_function("lowess",index=2) %>%{
  check_arg(., "x") %>% check_equal()
  check_arg(., "y") %>% chec_equal()
}
...
<h6 style="text-align: center;"><a id="displayOver4.4A" href="javascript:toggleDet('toggleOver4.4A','displayOver4.4A');"><i><strong>Show Overhead A Details. Unusual observationsUnusual observations</strong></i></a> </h6>
<div id="toggleOver4.4A" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver4.4B" href="javascript:toggleDet('toggleOver4.4B','displayOver4.4B');"><i><strong>Show Overhead B Details. Standardized residuals</strong></i></a> </h6>
<div id="toggleOver4.4B" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver4.4C" href="javascript:toggleDet('toggleOver4.4C','displayOver4.4C');"><i><strong>Show Overhead C Details. Outlier - an unusal standardized residual</strong></i></a> </h6>
<div id="toggleOver4.4C" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver4.4D" href="javascript:toggleDet('toggleOver4.4D','displayOver4.4D');"><i><strong>Show Overhead D Details. High leverage points</strong></i></a> </h6>
<div id="toggleOver4.4D" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver4.4E" href="javascript:toggleDet('toggleOver4.4E','displayOver4.4E');"><i><strong>Show Overhead E Details. High leverage point graph</strong></i></a> </h6>
<div id="toggleOver4.4E" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver4.4F" href="javascript:toggleDet('toggleOver4.4F','displayOver4.4F');"><i><strong>Show Overhead F Details. Leverage</strong></i></a> </h6>
<div id="toggleOver4.4F" style="display: none">
...
ex() %>% check_object("model_outlrC") %>% check_equal()
ex() %>% check_object("ri") %>% check_equal()
ex() %>% check_function("summary",index=1) %>% check_arg(., "object") %>% check_equal()
ex() %>% check_object("hii") %>% check_equal()
ex() %>% check_function("summary",index=2) %>% chec_arg(., "object") %>% check_equal()
...
ex() %>% check_function("hist",index=3) %>% {
  check_arg(., "x") %>% check_equal()
  check_arg(., "nclass") %>% check_equal()
}
ex() %>% check_object("mlr.survey3") %>% check_euqal()
ex() %>% check_function("summary",index=1) %>% check_arg(., "object") %>% check_equal()
ex() %>% check_function("summary",index=2) %>% check_arg(., "object") %>% check_equal()
...
<h6 style="text-align: center;"><a id="displayOver4.5A" href="javascript:toggleDet('toggleOver4.5A','displayOver4.5A');"><i><strong>Show Overhead A Details. Collinearity</strong></i></a> </h6>
<div id="toggleOver4.5A" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver4.5B" href="javascript:toggleDet('toggleOver4.5B','displayOver4.5B');"><i><strong>Show Overhead B Details. Quantifying collinearity</strong></i></a> </h6>
<div id="toggleOver4.5B" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver4.5C" href="javascript:toggleDet('toggleOver4.5C','displayOver4.5C');"><i><strong>Show Overhead C Details. Options for handling collinearity</strong></i></a> </h6>
<div id="toggleOver4.5C" style="display: none">
...
ex() %>% check_object("Term_mlr") %>% check_equal()
ex() %>% check_function("vif",index=1) %>% check_arg(., "mod") %>% check_equal()
ex() %>% check_object("Term_mlr1") %>% check_equal()
ex() %>% check_function("summary") %>% check_arg(., "object") %>% check_equal()
ex() %>% check_function("vif",index=2) %>% check_arg(., "mod") %>% check_equal()
...
<h6 style="text-align: center;"><a id="displayOver4.6A" href="javascript:toggleDet('toggleOver4.6A','displayOver4.6A');"><i><strong>Show Overhead A Details. Goodness of fit</strong></i></a> </h6>
<div id="toggleOver4.6A" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver4.6B" href="javascript:toggleDet('toggleOver4.6B','displayOver4.6B');"><i><strong>Show Overhead B Details. Goodness of fit and information criteria</strong></i></a> </h6>
<div id="toggleOver4.6B" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver4.6C" href="javascript:toggleDet('toggleOver4.6C','displayOver4.6C');"><i><strong>Show Overhead C Details. Out of sample validation</strong></i></a> </h6>
<div id="toggleOver4.6C" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver4.6D" href="javascript:toggleDet('toggleOver4.6D','displayOver4.6D');"><i><strong>Show Overhead D Details. Out of sample validation procedure</strong></i></a> </h6>
<div id="toggleOver4.6D" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver4.6E" href="javascript:toggleDet('toggleOver4.6E','displayOver4.6E');"><i><strong>Show Overhead E Details. Cross - validation</strong></i></a> </h6>
<div id="toggleOver4.6E" style="display: none">
