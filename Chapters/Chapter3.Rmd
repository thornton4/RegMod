...
<h6 style="text-align: center;"><a id="displayOver3.0A" href="javascript:toggleDet('toggleOver3.0A','displayOver3.0A');"><i><strong>Show Overhead A Details. Demand for term life insurance</strong></i></a> </h6>
<div id="toggleOver3.0A" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver3.0B" href="javascript:toggleDet('toggleOver3.0B','displayOver3.0B');"><i><strong>Show Overhead B Details. Term life insurance summary statistics</strong></i></a> </h6>
<div id="toggleOver3.0B" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver3.0C" href="javascript:toggleDet('toggleOver3.0C','displayOver3.0C');"><i><strong>Show Overhead C Details. Summary statistics</strong></i></a> </h6>
<div id="toggleOver3.0C" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver3.0D" href="javascript:toggleDet('toggleOver3.0D','displayOver3.0D');"><i><strong>Show Overhead D Details. Scatter plots of income versus face in original and logarithmic units</strong></i></a> </h6>
<div id="toggleOver3.0D" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver3.1A" href="javascript:toggleDet('toggleOver3.1A','displayOver3.1A');"><i><strong>Show Overhead A Details. Correlation table</strong></i></a> </h6>
<div id="toggleOver3.1A" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver3.1B" href="javascript:toggleDet('toggleOver3.1B','displayOver3.1B');"><i><strong>Show Overhead B Details. Scatterplot matrix</strong></i></a> </h6>
<div id="toggleOver3.1B" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver3.1C" href="javascript:toggleDet('toggleOver3.1C','displayOver3.1C');"><i><strong>Show Overhead C Details. Visualizing a regression plane</strong></i></a> </h6>
<div id="toggleOver3.1C" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver3.1D" href="javascript:toggleDet('toggleOver3.1D','displayOver3.1D');"><i><strong>Show Overhead D Details. Method of least squares</strong></i></a> </h6>
<div id="toggleOver3.1D" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver3.1E" href="javascript:toggleDet('toggleOver3.1E','displayOver3.1E');"><i><strong>Show Overhead E Details. Fit a multiple linear regression model</strong></i></a> </h6>
<div id="toggleOver3.1E" style="display: none">
...
**Hint.** Remember that your prediction is in log dollars so you need to exponentiate it to get the 
...
ex() %>% check_object("Term_mlr2") %>% check_equal()
...
ex() %>% check_object("logincome_pred") %>% check_equal()
ex() %>% check_object("pchange_income") %>% check_equal()
ex() %>% check_object("newdata2") %>% check_equal()
ex() %>% check_object("lsfits2") %>% chec_equal()
ex() %>% check_function("predict") %>% {
  check_arg(., "object") %>% check_equal()
  check_arg(., "newdata") %>% check_equal()
}
ex() %>% check_object("pchange_fits2") %>% check_equal()
ex() %>% check_expression("/",index=3) %>% check_result() %>% check_equal()
...
<h6 style="text-align: center;"><a id="displayOver3.2A" href="javascript:toggleDet('toggleOver3.2A','displayOver3.2A');"><i><strong>Show Overhead A Details. Goodness of fit</strong></i></a> </h6>
<div id="toggleOver3.2A" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver3.2B" href="javascript:toggleDet('toggleOver3.2B','displayOver3.2B');"><i><strong>Show Overhead B Details. Goodness of fit and term life</strong></i></a> </h6>
<div id="toggleOver3.2B" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver3.2C" href="javascript:toggleDet('toggleOver3.2C','displayOver3.2C');"><i><strong>Show Overhead C Details. Statistical inference</strong></i></a> </h6>
<div id="toggleOver3.2C" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver3.2D" href="javascript:toggleDet('toggleOver3.2D','displayOver3.2D');"><i><strong>Show Overhead D Details. Statistical inference and term life</strong></i></a> </h6>
<div id="toggleOver3.2D" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver3.3A" href="javascript:toggleDet('toggleOver3.3A','displayOver3.3A');"><i><strong>Show Overhead A Details. Binary variables</strong></i></a> </h6>
<div id="toggleOver3.3A" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver3.3B" href="javascript:toggleDet('toggleOver3.3B','displayOver3.3B');"><i><strong>Show Overhead B Details. Visualize effect of binary variables</strong></i></a> </h6>
<div id="toggleOver3.3B" style="display: none">

</div> 

<h6 style="text-align: center;"><a id="displayOver3.3C" href="javascript:toggleDet('toggleOver3.3C','displayOver3.3C');"><i><strong>Show Overhead C Details. R script for visualization</strong></i></a> </h6>
<div id="toggleOver3.3C" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver3.3D" href="javascript:toggleDet('toggleOver3.3D','displayOver3.3D');"><i><strong>Show Overhead D Details. Interaction Terms</strong></i></a> </h6>
<div id="toggleOver3.3D" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver3.3E" href="javascript:toggleDet('toggleOver3.3E','displayOver3.3E');"><i><strong>Show Overhead E Details. Visualizing binary variables with interactions terms</strong></i></a> </h6>
<div id="toggleOver3.3E" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver3.4A" href="javascript:toggleDet('toggleOver3.4A','displayOver3.4A');"><i><strong>Show Overhead A Details. Categorical variables</strong></i></a> </h6>
<div id="toggleOver3.4A" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver3.4B" href="javascript:toggleDet('toggleOver3.4B','displayOver3.4B');"><i><strong>Show Overhead B Details. Term life example</strong></i></a> </h6>
<div id="toggleOver3.4B" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver3.4C" href="javascript:toggleDet('toggleOver3.4C','displayOver3.4C');"><i><strong>Show Overhead C Details. Term life boxplots</strong></i></a> </h6>
<div id="toggleOver3.4C" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver3.4D" href="javascript:toggleDet('toggleOver3.4D','displayOver3.4D');"><i><strong>Show Overhead D Details. Regression with a categorical variable</strong></i></a> </h6>
<div id="toggleOver3.4D" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver3.4E" href="javascript:toggleDet('toggleOver3.4E','displayOver3.4E');"><i><strong>Show Overhead E Details. t-ratios depend on the reference level</strong></i></a> </h6>
<div id="toggleOver3.4E" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver3.5A" href="javascript:toggleDet('toggleOver3.5A','displayOver3.5A');"><i><strong>Show Overhead A Details. Testing the significance of a categorical variable</strong></i></a> </h6>
<div id="toggleOver3.5A" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver3.5B" href="javascript:toggleDet('toggleOver3.5B','displayOver3.5B');"><i><strong>Show Overhead B Details. Overview of the general linear hypothesis</strong></i></a> </h6>
<div id="toggleOver3.5B" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver3.5C" href="javascript:toggleDet('toggleOver3.5C','displayOver3.5C');"><i><strong>Show Overhead C Details.  Procedure for conducting the general linear hypothesis</strong></i></a> </h6>
<div id="toggleOver3.5C" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver3.5D" href="javascript:toggleDet('toggleOver3.5D','displayOver3.5D');"><i><strong>Show Overhead D Details. The general linear hypothesis for a single variable</strong></i></a> </h6>
<div id="toggleOver3.5D" style="display: none">
