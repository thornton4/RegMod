...
<h6 style="text-align: center;"><a id="displayOver1.1A" href="javascript:toggleDet('toggleOver1.1A','displayOver1.1A');"><i><strong>Show Overhead A Details. Description of the data</strong></i></a> </h6>
...
<h6 style="text-align: center;"><a id="displayOver1.1B" href="javascript:toggleDet('toggleOver1.1B','displayOver1.1B');"><i><strong>Show Overhead B Details. Read and examine data structure</strong></i></a> </h6>
...
<h6 style="text-align: center;"><a id="displayOver1.1C" href="javascript:toggleDet('toggleOver1.1C','displayOver1.1C');"><i><strong>Show Overhead C Details. Summary stats for parents' height</strong></i></a> </h6>
...
<h6 style="text-align: center;"><a id="displayOver1.1D" href="javascript:toggleDet('toggleOver1.1D','displayOver1.1D');"><i><strong>Show Overhead D. Fit a normal curve to parents' height details</strong></i></a> </h6>
...
<h6 style="text-align: center;"><a id="displayOver1.1E" href="javascript:toggleDet('toggleOver1.1E','displayOver1.1E');"><i><strong>Show Overhead E Details. Use the normal approximation to determine the probability of the height of tall parents</strong></i></a> </h6>
...
**Hint 1.** Use the function [dnorm()](https://www.rdocumentation.org/packages/stats/versions/3.5.0/topics/Normal/) to calculate the normal density, similar to the cumulative probabilites that you calculated using [pnorm()](https://www.rdocumentation.org/packages/stats/versions/3.5.0/topics/Normal/)
...
<h6 style="text-align: center;"><a id="displayOver1.2" href="javascript:toggleDet('toggleOver1.2','displayOver1.2');"><i><strong>Show Overhead Details. Data description</strong></i></a> </h6>
<div id="toggleOver1.2" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver1.2A" href="javascript:toggleDet('toggleOver1.2A','displayOver1.2A');"><i><strong>Show Overhead A Details. Bring in Data, Introduce Logarithmic Claims</strong></i></a> </h6>
<div id="toggleOver1.2A" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver1.2B" href="javascript:toggleDet('toggleOver1.2B','displayOver1.2B');"><i><strong>Show Overhead B Details. Show how to get a finer grid for histograms</strong></i></a> </h6>
<div id="toggleOver1.2B" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver1.2C" href="javascript:toggleDet('toggleOver1.2C','displayOver1.2C');"><i><strong>Show Overhead C Details. Introduce the density plot</strong></i></a> </h6>
<div id="toggleOver1.2C" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver1.3A" href="javascript:toggleDet('toggleOver1.3A','displayOver1.3A');"><i><strong>Show Overhead A Details. Summary statistics</strong></i></a> </h6>
<div id="toggleOver1.3A" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver1.3B" href="javascript:toggleDet('toggleOver1.3B','displayOver1.3B');"><i><strong>Show Overhead B Details. Boxplot</strong></i></a> </h6>
<div id="toggleOver1.3B" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver1.3C" href="javascript:toggleDet('toggleOver1.3C','displayOver1.3C');"><i><strong>Show Overhead C Details. QQ Plot</strong></i></a> </h6>
<div id="toggleOver1.3C" style="display: none">
...
**Hint.** Note that [qnorm()](https://www.rdocumentation.org/packages/stats/versions/3.5.0/topics/Normal/) (one `q`) is for a normal quantile and [qqnorm()](https://www.rdocumentation.org/packages/stats/versions/3.5.0/topics/qqnorm/). (two `q`'s!) is for the normal qq plot
...
ex() %>% check_object("q25",undefined_msg="Make sure to assign the 25th quantile to `q25") %>% check_equal()
ex() %>% check_object("qn25",undefined_msg="Make sure to assign the normal value associated with the 25th percentile to qn25") %>% check_equal()
...
ex() %>% check_function("summary",index=1) %>% check_arg("object") %>% check_equal(incorrect_msg="Make sure to get summary statistics of `injury2`.")
ex() %>% chec_function("summary",index=2) %>% check_arg("object") %>% check_equal()
...
<h6 style="text-align: center;"><a id="displayOver1.4A" href="javascript:toggleDet('toggleOver1.4A','displayOver1.4A');"><i><strong>Show Overhead A Details. Simulate a moderately skewed distribution, with transforms</strong></i></a> </h6>
<div id="toggleOver1.4A" style="display: none">
...
<h6 style="text-align: center;"><a id="displayOver1.4B" href="javascript:toggleDet('toggleOver1.4B','displayOver1.4B');"><i><strong>Show Overhead B Details. Visualize the distributions</strong></i></a> </h6>
<div id="toggleOver1.4B" style="display: none">
