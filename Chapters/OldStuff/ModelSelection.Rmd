...
**Example `r chapnum`.1.10. SOA Exam Question.** 
You are given: 
...
**Example `r chapnum`.3.7. SOA Exam Question. - Continued.** 
...
The **Bayes estimate** is the value that minimizes the expected loss $\mathrm{E~}[ l(\hat{\theta}, \theta)]$.
