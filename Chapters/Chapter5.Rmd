...
ex() %>% check_function("par",index=2) %>% chec_arg(., "mfrow") %>% check_equal()
...
ex() %>% check_function("plot",index=1) %>% check _arg(., "x") %>% check_equal()
...
eexplvars4 <- c("gender","age","race","region","educ","phstat","mpoor","anylimit","income","insure","usc","unemploy","managedcare")
