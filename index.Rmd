...
<h5 style="text-align: center;"><a id="displayOverWelcomeA" href="javascript:toggleDet('toggleOverWelcomeA','displayOverWelcomeA');"><i><strong>Show Overhead A. Galton's 1885 Regression Data</strong></i></a> </h5>
<div id="toggleOverWelcomeA" style="display: none">
...
<h5 style="text-align: center;"><a id="displayOverWelcomeB" href="javascript:toggleDet('toggleOverWelcomeB','displayOverWelcomeB');"><i><strong>Show Overhead B. Supporting R Code</strong></i></a> </h5>
<div id="toggleOverWelcomeB" style="display: none">
